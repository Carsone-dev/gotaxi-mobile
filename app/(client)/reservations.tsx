...
const ORDRE: Partial<Record<ReservationStatus, number>> = {
  EN_ATTENTE: 0, CONFIRMEE: 1, TERMINEE: 2,
};
...
export default function ReservationsScreen() {
  ...
  if (active.length > 0) {
    ...
    active.forEach((r) => nodes.push({ kind: "item", id: r.id, data: r, index: idx++ }));
  }
  if (history.length > 0) {
    nodes.push({ kind: "section", id: "s-history", label: "Historique", count: history.length });
    history.forEach((r) => nodes.push({ kind: "item", id: r.id, data: r, index: idx++ }));
  }
              ...
              return (
                <View style={styles.sectionRow}>
                  ...
                  <View style={styles.sectionBadge}>
                    <Text style={styles.sectionBadgeTxt}>{item.count}</Text>
                  </View>
                </View>
              );
            }
...
const styles = StyleSheet.create({
  ...
  listContent: { padding: spacing["2xl"], paddingBottom: 48, gap: spacing.md },
  ...
  routeWrap: { flexDirection: "row", alignItems: "center", height: 14 },
  routeLine: {
  ...
  routeDot: {
    ...
    borderWidth: 2, borderColor: colors.white, zIndex: 1,
  },
  routeDotStart: { backgroundColor: colors.primary },
  routeDotEnd:   { backgroundColor: colors.black },
  routeMiddle:   { flex: 1 },
  routeCities: { flexDirection: "row", alignItems: "center" },
  routeCity: {
    fontSize: typography.fontSize.base,
    fontFamily: typography.fontFamily.bold,
    color: colors.textPrimary,
  ...
  timelinePulse: { width: 10, height: 10, borderRadius: 5, backgroundColor: colors.primary },
  timelineCheck: {
    fontSize: 12, color: colors.white, fontFamily: typography.fontFamily.bold,
  },
  timelineLabel: {
  ...
  empty: {
    alignItems: "center", paddingTop: spacing["5xl"],
  ...
  emptyBtn: {
    ...
    borderRadius: radii.full,
    paddingHorizontal: spacing["3xl"], paddingVertical: spacing.md,
  },
  emptyBtnTxt: {
    fontSize: typography.fontSize.base,
    fontFamily: typography.fontFamily.semiBold,
